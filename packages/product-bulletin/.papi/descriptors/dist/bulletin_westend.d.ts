...
declare const _allDescriptors: Bulletin_westend;
export default _allDescriptors;
export type Bulletin_westendApis = ApisFromDef<IRuntimeCalls>;
export type Bulletin_westendQueries = QueryFromPalletsDef<PalletsTypedef>;
export type Bulletin_westendCalls = TxFromPalletsDef<PalletsTypedef>;
export type Bulletin_westendEvents = EventsFromPalletsDef<PalletsTypedef>;
export type Bulletin_westendErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type Bulletin_westendConstants = ConstFromPalletsDef<PalletsTypedef>;
export type Bulletin_westendViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type Bulletin_westendCallData = Anonymize<Icd41grt22tk3v> & {
    value: {
        type: string;
    };
};
...
export type Bulletin_westendWhitelistEntry = PalletKey | `query.${NestedKey<AllInteractions['storage']>}` | `tx.${NestedKey<AllInteractions['tx']>}` | `event.${NestedKey<AllInteractions['events']>}` | `error.${NestedKey<AllInteractions['errors']>}` | `const.${NestedKey<AllInteractions['constants']>}` | `view.${NestedKey<AllInteractions['viewFns']>}` | `api.${NestedKey<AllInteractions['apis']>}`;
type PalletKey = `*.${({
