 ...
 * `index.ts` so consumers (and tests) can import the debug surface
 * without loading the attestation / session-manager modules, which
 * pull in verifiablejs WASM that can't initialise in all environments.
 */
