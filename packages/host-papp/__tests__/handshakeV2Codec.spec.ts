...
describe('HandshakeSuccessV2 (spec v0.2.2, 226 bytes)', () => {
  it('round-trips all fields incl. ssoEncPubKey', () => {
    const input = {
      ...
      ssoEncPubKey: new Uint8Array(65).fill(0x07),
  ...
  it('encodes to exactly 226 bytes (32 + 32 + 32 + 65 + 65)', () => {
...
describe('HandshakeSuccessV2_v021 (legacy spec v0.2.1, 161 bytes)', () => {
...
describe('decodeEncryptedHandshakeResponseV2 (length-dispatched plaintext decoder)', () => {
  ...
  it('decodes a 226-byte v0.2.2 Success body with ssoEncPubKey', () => {
    ...
    expect(decoded.value.ssoEncPubKey).toEqual(new Uint8Array(65).fill(0x07));
  ...
  it('decodes a 161-byte v0.2.1 Success body and surfaces ssoEncPubKey as null', () => {
  ...
  it('decodes a 129-byte v0.2 Success body and surfaces rootAccountId AND ssoEncPubKey as null', () => {
