...
- **IMPORTANT**: The [truapi specification](https://github.com/paritytech/host-rust-core/tree/main/rust/crates/truapi) is the source of truth for the host ↔ product protocol. Any protocol change must land in the specification first, then be synced to `host-api` and any other affected packages — never the other way around.
