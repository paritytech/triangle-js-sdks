...
- add handoff-service package for P2P file transfers via HOP ([#109](https://github.com/paritytech/triangle-js-sdks/pull/109))
...
- **host-substrate-chain-connection:** add pause/resume to drop the inner socket cleanly ([9685af6](https://github.com/paritytech/triangle-js-sdks/commit/9685af6))
...
- infinite reconnects ([f72816c](https://github.com/paritytech/triangle-js-sdks/commit/f72816c))
